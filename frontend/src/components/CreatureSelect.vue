            ...
            <div class="flex items-center gap-2">
              <div v-if="creature.unlockStats?.unlocked_count"
                ...
                <div class="fixed z-[100] left-0 top-0 w-full h-0 pointer-events-none">
                  <div
                    class="invisible group-hover/tooltip:visible opacity-0 group-hover/tooltip:opacity-100 transition-opacity absolute z-50 w-48 p-2 bg-white rounded-lg shadow-lg border border-gray-200 pointer-events-auto"
                    :style="{
                      left: `${$el?.getBoundingClientRect().right + 8}px`,
