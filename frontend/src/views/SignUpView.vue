      ...
      <div class="space-y-4">
        ...
        <div class="relative">
          ...
          <div class="relative flex justify-center text-sm">
            <span class="px-2 bg-gray-100 text-gray-500">{{ t('auth.signUp.withProvider.title') }}</span>
          </div>
        </div>
        ...
        <form class="mt-8 space-y-6" @submit.prevent="handleSubmit">
          <div class="rounded-md shadow-sm -space-y-px">
            <div>
              <label for="email-address" class="sr-only">{{ t('auth.signUp.withEmail.email') }}</label>
              <input
                v-model="email"
                id="email-address"
                name="email"
            ...
            <div>
              <label for="password" class="sr-only">{{ t('auth.signUp.withEmail.password') }}</label>
              <input
                v-model="password"
                id="password"
                name="password"
            ...
            <div>
              <label for="confirm-password" class="sr-only">{{ t('auth.signUp.withEmail.confirmPassword') }}</label>
              <input
