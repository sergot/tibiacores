  ...
  <div class="w-full bg-gradient-to-b from-gray-50 to-gray-100 min-h-[calc(100vh-8rem)]">
    <main class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div class="grid gap-8 md:grid-cols-2">
        ...
        <div class="group bg-white p-8 rounded-xl shadow-sm border border-gray-200 hover:shadow-lg transition-all duration-300 hover:border-indigo-200">
        ...
        <!-- Features section -->
        <div class="group bg-white p-8 rounded-xl shadow-sm border border-gray-200 hover:shadow-lg transition-all duration-300 hover:border-green-200">
          <div class="flex items-start space-x-4 mb-4">
        ...
        <!-- Contribute section -->
        <div class="group bg-white p-8 rounded-xl shadow-sm border border-gray-200 hover:shadow-lg transition-all duration-300 hover:border-blue-200">
          <div class="flex items-start space-x-4 mb-4">
          ...
          <ul class="space-y-4 text-gray-600">
            <li class="flex items-center space-x-3 group-hover:transform group-hover:translate-x-1 transition-transform">
              ...
              <div class="flex-1">
                <a href="https://github.com/sergot/tibiacores" target="_blank" rel="noopener noreferrer" class="text-blue-600 hover:text-blue-800 hover:underline">
        ...
        <!-- Coming Soon section -->
        <div class="group bg-white p-8 rounded-xl shadow-sm border border-gray-200 hover:shadow-lg transition-all duration-300 hover:border-purple-200">
          <div class="flex items-start space-x-4 mb-4">
        ...
        <!-- Donation section -->
        <div class="group bg-white p-8 rounded-xl shadow-sm border border-gray-200 hover:shadow-lg transition-all duration-300 hover:border-yellow-200">
          <div class="flex items-start space-x-4 mb-4">
        ...
        <!-- Contact section -->
        <div class="group bg-white p-8 rounded-xl shadow-sm border border-gray-200 hover:shadow-lg transition-all duration-300 hover:border-red-200">
          <div class="flex items-start space-x-4 mb-4">
