  ...
  <div class="w-full">
    <main class="max-w-6xl mx-auto px-8 py-8">
      <div class="text-center mb-8">
        ...
        <p class="text-xl text-gray-600">Your companion app for managing and sharing gaming lists</p>
      </div>
      ...
      <div v-if="userStore.isAuthenticated" class="mb-8 p-8 rounded-xl bg-white shadow-md">
        ...
        <div v-else-if="!listsStore.hasLists" class="text-center py-12">
          <div class="bg-gray-50 rounded-lg p-8 max-w-md mx-auto">
            <p class="text-gray-700 font-medium mb-2">You haven't created or joined any lists yet.</p>
        ...
        <div v-else class="grid gap-6">
          <div v-for="list in listsStore.lists" :key="list.id" 
            ...
            <div class="flex justify-between items-start">
              <div class="space-y-2">
                <h3 class="font-semibold text-xl text-gray-800 group-hover:text-gray-900">{{ list.name }}</h3>
                <div class="space-y-1">
                  ...
                  <p v-if="list.character_name" class="text-sm text-gray-600 flex items-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                    </svg>
                    {{ list.is_author ? 'Owner Character' : 'Member Character' }}: {{ list.character_name }}
                  </p>
                </div>
              </div>
              <div class="flex items-center gap-2">
                <span v-if="list.is_author" 
      ...
      <div class="mt-8 p-6 rounded-lg bg-white text-center">
        ...
        <p class="text-gray-600 leading-relaxed">Fiendlist is your companion app for managing and sharing gaming lists. Create characters, build your collections, and share them with friends. Join existing lists using share codes or direct links.</p>
      </div>
    </main>
  </div>
</template>
